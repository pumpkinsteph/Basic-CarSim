...
float Fdx(sf::Vector2f velocity_fdx_in, float drag_area_fdx_in, float dragCoefficient_fdx_in) {
	return (-0.5f * airDensity * drag_area_fdx_in * dragCoefficient_fdx_in * velocity_fdx_in.x * velocity_fdx_in.x);
}

float Fdy(sf::Vector2f velocity_fdy_in, float drag_area_fdy_in, float dragCoefficient_fdy_in) {
	return (-0.5f * airDensity * drag_area_fdy_in * dragCoefficient_fdy_in * velocity_fdy_in.y * velocity_fdy_in.y); 
}